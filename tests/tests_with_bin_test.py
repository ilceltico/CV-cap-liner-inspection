    ...
    for file in os.listdir('./caps'):
        ...
        for blob in blobs:
                ...
                for i in range(0,10):
                    ...
                    color = (np.random.randint(0,255),np.
                    random.randint(0,255),np.random.randint(0,255))
                    ...
                    #if r < rCap - 5 and r > 150:
                        if r < 0.99*rCap:
                            circles.append((x, y, r, len(blobX[i*length:maxIndex]), (blobX, blobY)))
